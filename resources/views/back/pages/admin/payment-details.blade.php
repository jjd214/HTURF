...
@section('content')
            ...
            <div class="pd-20 card-box height-100-p shadow-sm border rounded bg-white">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 d-flex justify-content-end align-items-center">
                        ...
                        @else
                            <div class="col-md-6 d-flex justify-content-end align-items-center">
                                <img src="{{ $consignorDetails['picture'] }}" alt="Item Image" class="img-thumbnail"
            ...
            <div class="card-box height-100-p overflow-hidden pd-20 shadow-sm border rounded bg-white">
                ...
                <div class="receipt-content">
                    ...
                    @if ($paymentDetails['status'] === 'Pending')
                        ...
                        <!-- Claim Payment Modal -->
                        <div class="modal fade" id="claimPaymentModal" tabindex="-1" role="dialog"
                            aria-labelledby="claimPaymentModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="claimPaymentModalLabel">Set Date and Time for Claiming
                                            Payment</h5>
    ...
    <div class="thermal-print" id="thermal-receipt" style="display: none;">
        <style>
            ...
            .thermal-print .item-detail,
            .thermal-print .total-detail {
                display: flex;
    ...
    <script>
        function printReceipt() {
            ...
            printWindow.document.write(
                'body { font-family: monospace; font-size: 12px; text-align: center; margin: 0; padding: 10px; }');
