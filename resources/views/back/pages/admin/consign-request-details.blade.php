...
@section('content')
        ...
        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 mb-4">
            <div class="pd-20 card-box height-100-p shadow-sm border rounded bg-white">
                ...
                <div class="image-container"
                    style="display: flex; justify-content: start; padding: 5px; border: 1px solid grey; border-radius: 7px; width: 100%; height: 80px; overflow: auto; flex-direction: row; column-gap: 5px; margin-bottom: 10px;">
                    @php
                        $images = $consignmentRequestDetails->image
                            ? json_decode($consignmentRequestDetails->image, true)
                            : [];
                    @endphp
                    @foreach ($images as $image)
                        <img src="{{ Storage::url('images/requests/' . trim($image, '[]"')) }}"
                            class="img-thumbnail img-clickable" style="cursor: pointer;">
                    @endforeach
                </div>
                <hr>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $consignmentRequestDetails['name'] }}"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $consignmentRequestDetails['sku'] }}"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $consignmentRequestDetails['colorway'] }}"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $consignmentRequestDetails['size'] }}"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $consignmentRequestDetails['sex'] }}"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $consignmentRequestDetails['condition'] }}" @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for=""><small><b>Quantity</b></small></label>
                            <input type="text" class="form-control" value="{{ $consignmentRequestDetails['quantity'] }}"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $consignmentRequestDetails['purchase_price'] }}" @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="{{ $consignmentRequestDetails['selling_price'] }}" @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="{{ number_format($consignmentRequestDetails['consignor_commission'], 0) }}%"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"
                                value="{{ \Carbon\Carbon::parse($consignmentRequestDetails['pullout_date'])->toFormattedDateString() }}"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $consignmentRequestDetails['status'] }}"
                                @readonly(true)>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-center mb-2">
                            ...
                            <img src="{{ $consignorDetails['picture'] }}" alt="Profile Picture"
                                class="img-thumbnail border-radius-100 img-clickable"
    ...
    <form id="accept-form"
        action="{{ route('admin.consignment.accept-consignment-request', $consignmentRequestDetails['id']) }}"
    ...
    <form id="reject-form"
        action="{{ route('admin.consignment.reject-consignment-request', $consignmentRequestDetails['id']) }}"
        method="POST" style="display:none;">
        @csrf
        @method('POST')
    </form>
