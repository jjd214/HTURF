					...
					<ul id="accordion-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="submenu">
                                ...
                                <li>
                                    <a href="{{ route('admin.sales.all-transactions') }}" class="{{ Route::is('admin.sales.all-transactions') ? 'active' : '' }}">Transactions
                                    </a>
                                </li>
                                <li>
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="submenu">
                                ...
                                <li><a  href="{{ route('admin.product.add-product') }}" class="{{ Route::is('admin.product.add-product') ? 'active' : '' }}">Add product</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle {{ Route::is('admin.consignment.*') ? 'active' : '' }}">
