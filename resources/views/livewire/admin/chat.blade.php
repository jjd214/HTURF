                ...
                <div class="chat-list bg-light-gray">
                    ...
                    <div class="notification-list chat-notification-list customscroll mCustomScrollbar _mCS_4">
                        <div id="mCSB_4" class="mCustomScrollBox mCS-dark-2 mCSB_vertical mCSB_inside"
                            ...
                            <div id="mCSB_4_container" class="mCSB_container" style="position:relative; top:0; left:0;"
                                dir="ltr">
                                <ul>
                                    @forelse ($users as $user)
                                        <li class="active">
                                            <a href="#">
                                                <img src="{{ $user->picture }}" alt="" class="mCS_img_loaded">
                            ...
                            <div id="mCSB_4_scrollbar_vertical"
                                ...
                                <div class="mCSB_draggerContainer">
                                    <div id="mCSB_4_dragger_vertical" class="mCSB_dragger"
                                        style="position: absolute; min-height: 30px; display: block; height: 196px; max-height: 409.68px; top: 0px;">
                                ...
                                <div id="mCSB_5_scrollbar_vertical"
                                    ...
                                    <div class="mCSB_draggerContainer">
                                        <div id="mCSB_5_dragger_vertical" class="mCSB_dragger"
                                            style="position: absolute; min-height: 30px; display: block; height: 53px; max-height: 322.68px; top: 0px;">
                                            <div class="mCSB_dragger_bar" style="line-height: 30px;"></div>
                                        </div>
                                        <div class="mCSB_draggerRail"></div>
                                    </div>
