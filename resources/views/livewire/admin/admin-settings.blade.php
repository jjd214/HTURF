<div>
    <div class="tab">
        <ul class="nav nav-tabs customtab" role="tablist">
            ...
            <li class="nav-item">
                <a wire:click.prevent='selectTab("logo_favicon")' class="nav-link {{ $tab == 'logo_favicon' ?'active' : '' }} " data-toggle="tab" href="#logo_favicon" role="tab" aria-selected="false">Logo and Favicon</a>
            </li>
            <li class="nav-item">
                    ...
                    <form wire:submit.prevent="updateGeneralSettings" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label for=""><b>Site meta keywords: </b><small>Seperated by comma (a,b,c)</small></label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="" id="" cols="4" rows="4" class="form-control" wire:model.defer="site_meta_description"></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-2 mt-1" style="max-width: 200px;">
                                <img wire:ignore src="/images/site/{{ $site_logo }}" alt="" data-ijabo-default-img="/images/site/{{ $site_logo }}" id="site_logo_image_preview" class="img-thumbnail">
                            </div>
                            <form action="{{ route('admin.change-logo') }}" method="post" enctype="multipart/form-data" id="change_site_logo_form">
                                @csrf
                                <div class="mb-2">
                                    <input type="file" wire:model="site_logo" name="site_logo" id="site_logo" class="form-control">
                                ...
                                <button wire:loading.attr="disabled" type="submit" class="btn btn-primary">Change logo</button>
                            </form>
                        </div>
                        <div class="col-md-6">
                            <h5>Site favicon</h5>
                            <div class="mb-2 mt-1" style="max-width: 100px">
                                <img wire:ignore src="/images/site/{{ $site_favicon }}" alt="" class="img-thumbnail" id="site_favicon_image_preview" data-ijabo-default-img="/images/site/{{ $site_favicon }}">
                            </div>
                            <form action="{{ route('admin.change-favicon') }}" method="post" enctype="multipart/form-data" id="change_site_favicon_form">
                                @csrf
                                <div class="mb-2">
                                    <input type="file" name="site_favicon" wire:model="site_favicon" id="site_favicon" class="form-control">
                                    <span class="text-danger error-text site_favicon_error"></span>
                                    <div wire:loading wire:target="site_favicon">
                                        <span class="text-success">Loading...</span>
                                    </div>
                                </div>
                                <button wire:loading.attr="disabled" type="submit" class="btn btn-info">Change favicon</button>
                            </form>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model.defer="facebook_url" class="form-control" placeholder="Enter facebook url">
                                    @error('facebook_url')
                                        {{ $message }}
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model.defer="instagram_url" class="form-control" placeholder="Enter instagram url">
                                    @error('instagram_url')
                                        {{ $message }}
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" wire:model.defer="twitter_url" class="form-control" placeholder="Enter twitter url">
                                    @error('twitter_url')
                                        {{ $message }}
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" wire:model.defer="tiktok_url" placeholder="Enter tiktok url">
                                    @error('tiktok_url')
                                        {{ $message }}
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" wire:model.defer="shoppee_url" placeholder="Enter shoppee url">
                                    @error('shoppee_url')
                                        {{ $message }}
                                    @enderror
                                </div>
